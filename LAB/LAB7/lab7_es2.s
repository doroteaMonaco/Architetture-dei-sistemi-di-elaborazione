...
Sort_loop
				CMP r3, #0
				BEQ fine1
				MOV r6, #-1 ;salva massimo
				MOV r7, #0  ;indice del massimo
				MOV r8, #0  ;indice corrente
...
Num_days		DCB 7
				...
				AREA |.text|, DATA, READWRITE
				align 2
Best_time_sort  SPACE 28
Failed_run_sort SPACE 28
				SPACE 4096
