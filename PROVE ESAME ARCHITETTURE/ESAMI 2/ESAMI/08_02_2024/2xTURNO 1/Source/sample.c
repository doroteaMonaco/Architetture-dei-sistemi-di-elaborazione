...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0.1*0x3D090); //0.01s*25000000
	init_timer(1, 0, 0, 0x3, 0x2DC6C0); //0.120s*25000000
	init_timer(2, 0, 0, 0x3, 0.2*0x7735940); //5s*25000000 
	enable_timer(2);
	init_timer(3, 0, 0, 0x3, 0.1*0x8F0D180); //6s*25000000
