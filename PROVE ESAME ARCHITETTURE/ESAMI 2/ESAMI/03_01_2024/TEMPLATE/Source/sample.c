...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(2, 0, 0, 0x2, 0x997B61C0); //103s*25000000 
	init_timer(0, 0, 0, 0x3, 0.5*0xBAEB90); //0.49s*25000000 
	init_timer(1, 0, 0, 0x3, 0.5*0xFF95B0); //0.67s*25000000 
