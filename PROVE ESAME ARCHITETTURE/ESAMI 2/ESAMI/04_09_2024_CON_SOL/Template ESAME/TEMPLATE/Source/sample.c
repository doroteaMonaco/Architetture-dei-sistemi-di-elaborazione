...
unsigned int var;
void clearvett();
unsigned int avg_vett(unsigned int *vett1, unsigned int dim, char *flag);
unsigned char extract_LSB(unsigned char val);
int lampeggio=1;
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(1, 0, 0, 0x3, 0x2887FA0); //1.7s*25000000
	init_timer(2, 0, 0, 0x2, 0x2B82EA80); //14.6s*50000000
	enable_timer(1);
	enable_timer(2);
	init_timer(3, 0, 0, 0x3, 0x10B0760); //0.7s*25000000
