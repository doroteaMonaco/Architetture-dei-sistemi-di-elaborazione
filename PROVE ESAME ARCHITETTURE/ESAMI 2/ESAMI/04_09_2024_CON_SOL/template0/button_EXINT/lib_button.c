...
void BUTTON_init(void) {
  ...
  LPC_PINCON->PINSEL4    |= (1 << 20);		 /* EINT0 => 21/20 => 01 => INT */
  LPC_GPIO2->FIODIR      &= ~(1 << 10);    /* PORT2.10 defined as input          */

  LPC_PINCON->PINSEL4    |= (1 << 22);     /*  EINT1 => 23/22 => 01 => INT */
  LPC_GPIO2->FIODIR      &= ~(1 << 11);    /* PORT2.11 defined as input          */
  
  LPC_PINCON->PINSEL4    |= (1 << 24);     /*  EINT2 => 25/24 => 01 => INT */
  LPC_GPIO2->FIODIR      &= ~(1 << 12);    /* PORT2.12 defined as input          */

  LPC_SC->EXTMODE = 0x7; /* EXTMODE EDGE SENSITIVE */
	/* EXTPOLAR FALLING EDGE*/
