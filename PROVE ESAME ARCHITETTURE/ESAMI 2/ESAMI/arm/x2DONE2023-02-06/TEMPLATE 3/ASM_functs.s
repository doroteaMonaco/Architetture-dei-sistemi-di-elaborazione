...
differenza_media_positivi_negativi PROC
				...
				MOV R9, #1 ;da stampare per OVERFLOW
				
				MOV R3, #0 ; somma numeri positivi
				MOV R4, #0 ; somma numeri negativi
				
				MOV R5, #0 ; numero di nuneri positivi
				MOV R6, #0 ; numero di nuneri negativi
...
mediap			SDIV R3, R3, R5 ;media positivi

				CMP R6, #0
				BEQ fine
				
median			SDIV R4, R4, R6 ;media negativi
