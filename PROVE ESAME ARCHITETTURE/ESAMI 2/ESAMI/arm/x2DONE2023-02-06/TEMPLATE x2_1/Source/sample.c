...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0.1*0x2FAF080); //2s*25000000
	init_timer(1, 0, 0, 0x3, 0.1*0x47868C0); //3s*25000000
	init_timer(2, 0, 0, 0x3, 0.1*0x4C4B40); //0.2s*25000000
	init_timer(3, 0, 0, 0x3, 0.1*0x5F5E10); //0.25s*25000000
