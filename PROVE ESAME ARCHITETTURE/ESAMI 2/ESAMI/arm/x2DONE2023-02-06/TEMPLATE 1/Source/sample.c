...
//NON � visibile
unsigned int calcola_somma_prodotto(unsigned int* v, unsigned int n, char* alarm);
void clear_vett();
uint32_t VAR1, VAR2, VETT[N];
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0x1312D0); // 50ms*25000000 conto i secondi con sensibilità 50ms
	init_timer(1, 0, 0, 0x3, 0x7A120); //20ms*25000000 per display VAR
	init_timer(2, 0, 0, 0x3, 0x98968); //25ms*25000000 per display sum
	init_timer(3, 0, 0, 0x3, 0x7A120); //20ms*25000000 per display VAR
