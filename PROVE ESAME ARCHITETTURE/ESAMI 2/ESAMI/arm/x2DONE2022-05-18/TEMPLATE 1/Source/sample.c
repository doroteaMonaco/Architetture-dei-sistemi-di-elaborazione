...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0x2625A0); //0.1s*25000000 conto i decimi di secondo
	init_timer(1, 0, 0, 0x3, 0x2FAF080); //2s*25000000
	init_timer(2, 0, 0, 0x3, 0x23C3460); //1.5s*25000000
