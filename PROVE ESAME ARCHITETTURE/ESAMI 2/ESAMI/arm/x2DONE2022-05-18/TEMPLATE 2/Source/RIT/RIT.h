...
extern unsigned char VAR, VETT[N];
extern int index, counter0, counter1, counter2, res, disabilitato;
extern unsigned int totale_pressioni_con_filtro(unsigned char* V, unsigned int  
