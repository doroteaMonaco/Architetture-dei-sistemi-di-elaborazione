...
search_in_pool	PROC					
				...
				MOV R1, #3 ;lunghezza pool
				MOV R5, #0 ;indice elementi
				
				LDR R2, =pool ;indirizzo vettore
...
ExtractBits		PROC	
				...
				LDR R1, [R0] ;prendo numero su 32 bit
					
				AND R2, R1, #255 ;prendo 8 bit bassi
				LSR R1, R1, #8 ;passo agli 8 bit successivi
				STR R1, [R0] ;stampo numero per prossima iterazione
