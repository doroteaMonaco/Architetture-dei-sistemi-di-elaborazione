...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0x17D7840); //1s*25000000 conto 1 secondo per UP
	init_timer(1, 0, 0, 0x3, 0x17D7840); //1s*25000000 conto 1 secondo per DOWN
	init_timer(2, 0, 0, 0x3, 0x47868C0); //3s*25000000 conto 3 secondi per KEY1
	init_timer(3, 0, 0, 0x3, 0x2FAF080); //2s*25000000
