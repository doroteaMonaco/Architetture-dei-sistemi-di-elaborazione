...
int modalita=0; //0->MONITOR, 1->ACQUISIZIONE
int iterazioni=0, countdown=0, countup=0, duty_cycle=0, valore_iniziale=-1, valore_corrente=-1, index=0;
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_RIT(0x98968);									/* RIT Initialization 25 msec       	*/
	//enable_RIT();
	...
	*/
	...
	init_timer(3, 0, 0, 0x5, 0x17D7840); //1s*25000000
	init_timer(0, 0, 0, 0x3, 2*0x17D7840); //2s*25000000
	LED_Out(index);
	enable_timer(0);
