...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0x1312D0); // 50ms*25000000, conta il numero di 50ms di pressione
	init_timer(3, 0, 0, 0x3, 0x2FAF080);// 10s*25000000 0xEE6B280
	enable_timer(3);
	init_timer(2, 0, 0, 0x3, 0xBEBC20); // 0.5s*25000000 per display concat_sum
