...
unsigned char VETT[N]={35, 20, 80, 46}, VETT2[N];
char RES[N];
int index=0;
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 0x3, 0x2625A0); //0.1s*25000000
	init_timer(1, 0, 0, 0x3, 0.5*0x2625A0); //0.05s*25000000
	init_timer(2, 0, 0, 0x3, 1.25*0x2625A0); //0.125s*25000000
