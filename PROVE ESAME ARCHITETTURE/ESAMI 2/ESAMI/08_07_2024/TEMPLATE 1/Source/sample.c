...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0, 0, 0, 0x3, 0x1312D0); //conto il numero di 50ms dalla pressione al rilascio
	init_timer(1, 0, 0, 0x3, 0x2625A0); //0.1s
	init_timer(2, 0, 0, 0x3, 0x5F5E10); //0.25s
