...
updateRank		PROC
				PUSH {r4-r7, lr}           ; Salva i registri che userò temporaneamente

				; Inizializza i registri
				MOV r4, r0                ; r4 = SCORE
				MOV r5, r1                ; r5 = indirizzo CLASSIFICA
				MOV r6, r2                ; r6 = indirizzo max_diff
				MOV r7, r3                ; r7 = indirizzo PODIO
				MOV r8, #0                ; r8 = i = 0, contatore per scorrere CLASSIFICA
