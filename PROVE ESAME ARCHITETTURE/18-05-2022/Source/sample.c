...
void svuotaVettore(unsigned char VETT[N], int n);
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(1, 0, 0, 3, 0x2FAF080); //MR1	calcolo K=T*Fr=(1/60Hz)*25*10^6, dopo ogni K scatena l'evento e resetta il timer (R attivato), ho I attivato per entrare nell'handler
	init_timer(2, 0, 0, 3, 0x17D7840);
	init_timer(3, 0, 0, 3, 0x23C3460);
