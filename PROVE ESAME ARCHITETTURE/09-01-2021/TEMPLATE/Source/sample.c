...
void svuotaVettore();
int count_negative_and_odd(int *VETT, int n);
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	*/
	...
	init_timer(0, 0, 0, 1, 0x2625A0); //MR0  calcolo K/2, dopo il quale scatena l'evento, ho I attivato per entrare nell'handler
